...
exports.postGameToChannel = exports.postGameToAllChannels = exports.checkForMissedGames = exports.postGameManually = exports.startScoresMonitor = void 0;
...
exports.startScoresMonitor = startScoresMonitor;
/**
 * Posts a completed game to all configured scores channels
 */
async function postGameToAllChannels(game) {
    try {
...
exports.postGameToAllChannels = postGameToAllChannels;
/**
 * Posts a game result to a specific Discord channel
 */
async function postGameToChannel(game, guildId, channelId) {
    try {
        // Create the game embed with all the details
        const embed = embed_builder_1.VFLEmbedBuilder.createGameEmbed({
            homeTeam: {
        ...
        // Post to Discord
        const message = await discordClient.createMessage({ id: channelId, id_type: 'CHANNEL' }, '', []);
    ...
    try {
        ...
        for (const configDoc of configsSnapshot.docs) {
            ...
            try {
                ...
                await discordClient.createMessage({ id: channelId, id_type: 'CHANNEL' }, '', []);
            }
            catch (error) {
 ...
 */
function shouldPostLiveUpdate(game) {
 ...
 */
async function postGameManually(gameId) {
    try {
...
exports.postGameManually = postGameManually;
/**
 * Check for missed game results and post them
 */
async function checkForMissedGames() {
    try {
        console.log('🔍 Checking for missed game results...');
        const missedGamesSnapshot = await firebase_1.default.collection('vfl_games')
            .where('status', '==', 'completed')
            .where('postedToDiscord', '==', false)
...
exports.checkForMissedGames = checkForMissedGames;
//# sourceMappingURL=scores_monitor.js.map