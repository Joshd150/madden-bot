...
export declare enum SimResult {
    FORCE_WIN_AWAY = "FORCE_WIN_AWAY",
    FORCE_WIN_HOME = "FORCE_WIN_HOME",
    FAIR_SIM = "FAIR_SIM"
}
export type MaddenBroadcastEvent = {
    title: string;
    video: string;
};
export type YoutubeBroadcastEvent = {
    video: string;
};
...
export type DiscordLeagueConnectionEvent = {
    guildId: string;
    leagueId: string;
};
