export declare const MADDEN_SEASON = 2024;
export declare function getMessageForWeek(week: number): string;
export type Team = {
    ovrRating: number;
    injuryCount: number;
    divName: string;
...
export declare function formatRecord(standing: Standing): string;
...
export declare enum YesNoTrait {
    NO = 0,
    YES = 1
}
export declare enum DevTrait {
    NORMAL = 0,
    STAR = 1,
    SUPERSTAR = 2,
    XFACTOR = 3
}
export declare enum SensePressureTrait {
    PARANOID = 0,
    TRIGGER_HAPPY = 1,
    IDEAL = 2,
    AVERAGE = 3,
...
export declare enum CoverBallTrait {
    NEVER = 1,
    ON_BIG_HITS = 2,
    ON_MEDIUM_HITS = 3,
    FOR_ALL_HITS = 4,
...
export declare enum PlayBallTrait {
    CONSERVATIVE = 0,
    BALANCED = 1,
    AGGRESSIVE = 2
}
export declare enum PenaltyTrait {
    UNDISCIPLINED = 0,
    NORMAL = 1,
    DISCIPLINED = 2
}
export declare enum QBStyleTrait {
    POCKET = 0,
    BALANCED = 1,
    SCRAMBLING = 2
}
export declare enum LBStyleTrait {
    PASS_RUSH = 0,
    BALANCED = 1,
    COVER_LB = 2
}
...
export declare const POSITION_GROUP: string[];
export declare const oLinePositions: string[];
export declare const dLinePositions: string[];
export declare const dbPositions: string[];
export type RosterExport = {
    success: boolean;
    message: string;
    rosterInfoList: Array<Player>;
};
//# sourceMappingURL=madden_league_types.d.ts.map