 ...
 */
async function queryPlayerHistory(players) {
    const teams = await madden_db_1.default.getLatestTeams("3418359");
    try {
        ...
        for (const player of players) {
            ...
            const playerQuery = await firebase_1.default
            ...
            for (const doc of playerQuery.docs) {
                ...
                const historyRef = firebase_1.default.collection(`league_data/3418359/MADDEN_PLAYER/${doc.id}/history`);
...
//# sourceMappingURL=emc_roster_dumper.js.map